...
# ==================================================
# Link Hosting Kalian
sincan2="https://raw.githubusercontent.com/Sincan2/v2ray/main/ssh"
...
curl https://${sincan2}/nginx.conf > /etc/nginx/nginx.conf
curl https://${sincan2}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${sincan2}/index.html1"
